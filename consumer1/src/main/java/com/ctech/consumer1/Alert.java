...
public class Alert extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4938291628789593207L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Alert\",\"namespace\":\"com.ctech.consumer1\",\"fields\":[{\"name\":\"message\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public static com.ctech.consumer1.Alert.Builder newBuilder() {
    return new com.ctech.consumer1.Alert.Builder();
  }
   ...
   * @return A new Alert RecordBuilder
   */
  public static com.ctech.consumer1.Alert.Builder newBuilder(com.ctech.consumer1.Alert.Builder other) {
    return new com.ctech.consumer1.Alert.Builder(other);
  }
   ...
   * @return A new Alert RecordBuilder
   */
  public static com.ctech.consumer1.Alert.Builder newBuilder(com.ctech.consumer1.Alert other) {
    return new com.ctech.consumer1.Alert.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Alert>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.ctech.consumer1.Alert.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.ctech.consumer1.Alert other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.message)) {
        this.message = data().deepCopy(fields()[0].schema(), other.message);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ctech.consumer1.Alert.Builder setMessage(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ctech.consumer1.Alert.Builder clearMessage() {
      message = null;
